...
const Features = () => {
  return (
    <div className=''>
      <div class="bg-zinc-900 font-[sans-serif] text-white flex max-lg:flex-col p-6 my-8 gap-10">
      <div class="lg:max-w-md mx-auto">
        <h2 class="text-4xl font-extrabold mb-4">Discover Our Exclusive Features</h2>
        <p class="text-gray-500 text-sm">Laboris qui Lorem ad tempor ut reprehenderit. Nostrud anim nulla officia ea sit deserunt. Eu eu quis anim aute Laboris qui Lorem ad tempor ut reprehenderit. Eu eu quis anim aute.</p>
      </div>
      <div class="grid md:grid-cols-2 gap-12 max-md:max-w-lg mx-auto">
        <div class="text-left bg-blue-50 rounded-md p-6">
          ...
          <h3 class="text-xl font-semibold mt-6 mb-2">Customization</h3>
          <p class="text-gray-500 text-sm">Laboris qui Lorem ad tempor ut reprehenderit. Nostrud anim nulla officia ea sit deserunt. Eu eu quis anim aute Laboris qui Lorem ad tempor ut reprehenderit.</p>
        ...
        <div class="text-left bg-blue-50 rounded-md p-6">
          ...
          <h3 class="text-xl font-semibold mt-6 mb-2">Support</h3>
          <p class="text-gray-500 text-sm">Laboris qui Lorem ad tempor ut reprehenderit. Nostrud anim nulla officia ea sit deserunt. Eu eu quis anim aute Laboris qui Lorem ad tempor ut reprehenderit.</p>
          <button type="button" class="border px-4 py-2 rounded-md font-bold flex items-center text-sm mt-6 hover:bg-gray-50">
            Learn more <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="16" class="rotate-90 ml-1.5"><path fill="#333" d="M12.006 1a1 1 0 0 1 .838.463l7 11a1 1 0 0 1-.985 1.527l-3.364-.48a.434.434 0 0 0-.495.43V20c0 1.645-1.355 3-3 3s-3-1.355-3-3v-6.06a.434.434 0 0 0-.495-.43l-3.364.48a1 1 0 0 1-.985-1.527l7-11a1 1 0 0 1 .85-.463z" data-original="#000000" paint-order="fill markers stroke"></path></svg>
          </button>
        ...
        <div class="text-left bg-blue-50 rounded-md p-6">
          ...
          <h3 class="text-xl font-semibold mt-6 mb-2">Performance</h3>
          <p class="text-gray-500 text-sm">Laboris qui Lorem ad tempor ut reprehenderit. Nostrud anim nulla officia ea sit deserunt. Eu eu quis anim aute Laboris qui Lorem ad tempor ut reprehenderit.</p>
          <button type="button" class="border px-4 py-2 rounded-md font-bold flex items-center text-sm mt-6 hover:bg-gray-50">
            Learn more <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="16" class="rotate-90 ml-1.5"><path fill="#333" d="M12.006 1a1 1 0 0 1 .838.463l7 11a1 1 0 0 1-.985 1.527l-3.364-.48a.434.434 0 0 0-.495.43V20c0 1.645-1.355 3-3 3s-3-1.355-3-3v-6.06a.434.434 0 0 0-.495-.43l-3.364.48a1 1 0 0 1-.985-1.527l7-11a1 1 0 0 1 .85-.463z" data-original="#000000" paint-order="fill markers stroke"></path></svg>
          </button>
